        ...
        <nav class="navbar navbar-expand lg bg-warning">
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav nav-underline">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/posts">Post</a>
                    </li>
                    <li class=" nav-item">
                        <a class="nav-link" aria-current="page" href="/categories">Categorías</a>
                    </li>
                    <li class=" nav-item">
                        <a class="nav-link" aria-current="page" href="/labels">Etiquetas</a>
                    </li>
                    <li class=" nav-item">
                    ...
                    <li class=" nav-item">
                        <a class="nav-link" aria-current="page" href="/roles">Roles</a>
                    </li>
