...
<body>
    ...
    <div class="container-fluid container" style="margin-top: 5rem">
        ...
        <form class="form-floating" action="{{route('users.update', $users->id)}}" method="POST"
                ...
                <div class="breadcrumb">
                    <div class="col-md-6">
                        <div class="form-floating mb-3 w-75" style="margin-bottom: 1rem">
                            <input type="text" class="form-control" name="NombreUsuario" id="floatingInput"
                                placeholder="Nombre del usuario" value="{{isset($users->NombreUsuario)?$users->NombreUsuario:''}}" required>
                    ...
                    <div class=" col-md-6">
                        <div class="form-floating mb-3 w-75">
                            ...
                            value="{{isset($users->ApellidoUsuario)?$users->ApellidoUsuario:''}}" placeholder="Apellido del usuario">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3 w-75">
                            ...
                            value="{{isset($users->Email)?$users->Email:''}}" placeholder="Email">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3 w-75">
                            ...
                            value="{{isset($users->Password)?$users->Password:''}}" placeholder="Password">
