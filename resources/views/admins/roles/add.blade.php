...
<body>
    ...
    <div class="container-fluid container" style="margin-top: 5rem">
        <h2 class="shadow p-3 mb-5 rounded bg-primary-subtle">Crear un Rol</h2>
        <form class="form-floating" action="{{url('/roles')}}" method="POST">
            {{csrf_field()}}
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3 w-75" style="margin-bottom: 1rem">
                            <input type="text" class="form-control" name="NombreRol" id="floatingInput"
                                placeholder="Nombre del Rol" value="" required>
